...
def home():
    ...
    return render_template('index.html', host=_host(), cli=_cli(), avaliados=avaliados, sugeridos=sugeridos)
...
def kibana():
    ...
    return render_template('kibana.html', host=_host(), cli=_cli(), search=search, cards=cards["search"], limit=limit,
                           buscas=buscas)
